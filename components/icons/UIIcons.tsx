...
export const CurrencyDollarIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8v1m0 6v1m6-4H6a2 2 0 00-2 2v4a2 2 0 002 2h12a2 2 0 002-2v-4a2 2 0 00-2-2z" />
    </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6.22 6.22l2.12 2.12m1.42-4.24l2.12-2.12m-4.24 1.42L12 3.51M12 3.51V1m0 2.51L13.78 6.22m2.12-2.12l2.12 2.12m-4.24-1.42L18 3.51M18 3.51V1m0 2.51l-1.78 1.71M21 5h-4M19 3v4M12 21v-4M9.78 17.78l-2.12-2.12m4.24 1.42L12 20.49M12 20.49V23m0-2.51l-1.78-1.71m-2.12 2.12l-2.12-2.12m4.24 1.42L6 20.49M6 20.49V23m0-2.51l1.78-1.71" />
    </svg>
);
...
export const ManageCampaignsIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const BeakerIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 01-6.23-.693L4.2 15.3m15.6 0-1.57.393m0 0l-1.57-.393m1.57.393l-1.57.393M4.2 15.3l1.57.393m0 0l1.57-.393M5.8 15.693l-1.6-2.834M18.2 15.693l1.6-2.834" />
