...
import { CallsByCampaignData } from '../types';

interface CallsByCampaignChartProps {
  data: CallsByCampaignData[];
}

export const CallsByCampaignChart: React.FC<CallsByCampaignChartProps> = ({ data }) => {
  return (
